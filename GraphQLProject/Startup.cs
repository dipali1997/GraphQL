...
namespace GraphQLProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //below line enables the graphql in dot net core 
            services.AddGraphQL(options => { options.EnableMetrics = false; }).AddSystemTextJson();
            services.AddDbContext<GraphQLDbContext>(option =>option.UseSqlServer("Data Source=DESKTOP-Q6GK44H;Initial Catalog=CoffeeShopDb;Integrated Security=True;"));
